...
function Group({ subheader, items, slotProps,permissions }: NavGroupProps) {
  ...
  if (permissions && !canViewPermission(permissions)) {
    return null;
  }

  const renderContent = items.map((list) => (
    list.permissions && !canViewPermission(list.permissions) ? null :
